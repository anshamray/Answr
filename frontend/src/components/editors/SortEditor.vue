  ...
  <div class="space-y-4">
    ...
    <div class="space-y-2">
      <div
        ...
        :key="index"
        class="flex items-center gap-3 p-3 bg-white border-2 border-border hover:border-primary transition-colors cursor-move"
      ...
      >
        ...
        <input
          ...
          maxlength="75"
          class="flex-1 px-3 py-2 border-2 border-border bg-white focus:border-primary focus:outline-none"
        />
