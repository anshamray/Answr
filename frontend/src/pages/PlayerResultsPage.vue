      ...
      <div v-if="topThree.length >= 3" class="flex items-end justify-center gap-4 lg:gap-6 mb-8">
        ...
        <div class="flex flex-col items-center">
          <div class="mb-4 text-center">
            ...
            <div class="text-lg lg:text-xl font-bold truncate max-w-[120px]">{{ topThree[0]?.nickname || 'Player' }}</div>
            <div class="text-lg lg:text-2xl font-bold text-muted-foreground">{{ topThree[0]?.score?.toLocaleString() }}</div>
          </div>
        ...
        <div class="flex flex-col items-center mb-8">
          ...
          <div class="mb-4 text-center">
            ...
            <div class="text-xl lg:text-2xl font-bold truncate max-w-[140px]">{{ topThree[1]?.nickname || 'Player' }}</div>
            <div class="text-2xl lg:text-3xl font-bold text-warning">{{ topThree[1]?.score?.toLocaleString() }}</div>
          </div>
        ...
        <div class="flex flex-col items-center">
          <div class="mb-4 text-center">
            ...
            <div class="text-lg lg:text-xl font-bold truncate max-w-[120px]">{{ topThree[2]?.nickname || 'Player' }}</div>
            <div class="text-lg lg:text-2xl font-bold text-accent">{{ topThree[2]?.score?.toLocaleString() }}</div>
          </div>
